...
export function stripFlags(open: string, close: string) {
  return {
    open: open.charAt(2) === '~',
...
export function stripComment(comment: string) {
...
export function prepareMustache(
  this: YY,
...
export function prepareRawBlock(
  this: YY,
...
export function preparePartialBlock(
  this: YY,
